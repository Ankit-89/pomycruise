...
import HeroTileAllInclusive from '../index';
import data from '../data/po';

describe('<HeroTileAllInclusive />', () => {
    let wrapper;
    ...
    beforeEach(() => {
        ...
        wrapper = mount(<HeroTileAllInclusive {...customData} services={services} />);
    });

    test('HeroTileAllInclusive contains <h1> desc tag', () => {
        expect(wrapper.find('h1').length).toEqual(1);
    });

    test('HeroTileAllInclusive contains <p> desc tag', () => {
        expect(wrapper.find('.desc').length).toEqual(1);
    });

    test('HeroTileAllInclusive contains back button', () => {
