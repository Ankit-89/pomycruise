...
import ConfiguratorTab from '../index';

import data from '../data/po.json';

describe('<ConfiguratorTab/>', () => {
    let wrapper;
    let customData = data.attributes;
    ...
    beforeEach(() => {
        ...
        wrapper = mount(
            <ConfiguratorTab {...customData} services={services} />
        );
    });
    test('Should mount without problems ', () => {
        expect(wrapper.length).toEqual(1);
    });
    test('Should mount without problems loadInitialData', () => {
