...
import SliderHeroProduct from '../index';

describe('<SliderHeroProduct />', () => {
    let wrapper;
    ...
    beforeEach(() => {
        ...
        wrapper = mount(<SliderHeroProduct {...customData} />);
    });

    test('SliderHeroProduct should mount without problems', () => {
