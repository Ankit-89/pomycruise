...
import SliderRecommendedShorex from '../index';
import data from '../data/po';

describe('<SliderRecommendedShorex />', () => {
    let wrapper;
    ...
    beforeEach(() => {
        ...
        wrapper = mount(
            <SliderRecommendedShorex {...customData} services={services} />
        );
    });

    test('Slider Recommended should render', () => {
