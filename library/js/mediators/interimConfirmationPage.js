...
// P&O Components
import intermediateConfirmationLoader from '../../../components/intermediateConfirmationLoader';

import 'postbooking-theme/styles/pages/interimConfirmationPage/index.css';
...
const mediator = {
    ...
    initReact() {
        const _COMPONENTS = {
            ...
            body: [
                {
                    id: 'interimConfirmationPage',
                    Component: intermediateConfirmationLoader
                }
            ]
        };
