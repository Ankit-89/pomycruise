...
// P&O Components
import diningKeyInfoMycruise from '../../../components/diningKeyInfoMycruise';
import shipsGrid from '../../../components/shipsGrid';
import diningTabsMycruise from '../../../components/diningTabsMycruise';
...
import 'postbooking-theme/styles/pages/diningProductDetailsPage/index.css';
...
const mediator = {
    ...
    initReact() {
        const _COMPONENTS = {
            ...
            body: [
                {
                    id: 'diningKeyInfoMycruise',
                    Component: diningKeyInfoMycruise
                },
                { id: 'shipsGrid', Component: shipsGrid },
                { id: 'diningTabsMycruise', Component: diningTabsMycruise },
