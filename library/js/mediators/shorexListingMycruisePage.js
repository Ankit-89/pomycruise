...
import filterSortBarMycruise from '../../../components/filterSortBarMycruise';
import footerMycruise from '../../../components/footerMycruise';

import 'postbooking-theme/styles/pages/shorexListingMycruisePage/index.css';
    ...
    initReact() {
        const _COMPONENTS = {
            ...
            body: [
                ...
                {
                    id: 'filterSortBarMycruise',
                    Component: filterSortBarMycruise
                },
