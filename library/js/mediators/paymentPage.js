...
import  anyPayIframe from '../../../components/anyPayIframe';

import footerMycruise from '../../../components/footerMycruise';

import 'postbooking-theme/styles/pages/entertainmentPage/index.css';
    ...
    initReact() {
        const _COMPONENTS = {
            ...
            body: [
                ...
                { id: 'anyPayIframe', Component: anyPayIframe },
