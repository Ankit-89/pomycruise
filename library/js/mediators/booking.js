...
// P&O Components
import diningbookingconfig from '../../../components/diningBookingConfig';
import footerMycruise from '../../../components/footerMycruise';

import 'postbooking-theme/styles/pages/booking/index.css';
...
const mediator = {
    ...
    initReact() {
        const _COMPONENTS = {
            ...
            body: [
                { id: 'diningbookingconfig', Component: diningbookingconfig },
