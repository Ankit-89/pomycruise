...
import summaryDetailsModuleMycruise from '../../../components/summaryDetailsModuleMycruise';
import continueShopping from '../../../components/continueShopping';
import footerMycruise from '../../../components/footerMycruise';

import 'postbooking-theme/styles/pages/shoppingCartMycruisePage/index.css';
...
const mediator = {
    ...
    initReact() {
        const _COMPONENTS = {
            ...
            body: [
                {
                    id: 'summaryDetailsModuleMycruise',
                    Component: summaryDetailsModuleMycruise
                },
