...
import mediaGalleryApi from '../../../components/mediaGalleryApi';
import accordionMycruise from '../../../components/accordionMycruise';
import heroMycruise from '../../../components/heroMycruise';
import sliderPopularShorex from '../../../components/sliderPopularShorex';
...
import 'postbooking-theme/styles/pages/shorexLandingMycruisePage/index.css';
    ...
    initReact() {
        const _COMPONENTS = {
            ...
            body: [
                ...
                { id: 'sliderPopularShorex', Component: sliderPopularShorex },
                {
