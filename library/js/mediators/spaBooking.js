...
// P&O Components
import spaConfig from '../../../components/spaConfig';
// import spaConfigLabels from '../../../components/spaConfigLabels';

import 'postbooking-theme/styles/pages/spaBooking/index.css';
...
const mediator = {
    ...
    initReact() {
        const _COMPONENTS = {
            ...
            body: [
                { id: 'spaConfig', Component: spaConfig }
                // { id: 'spaConfigLabels', Component: spaConfigLabels }
            ]
        };
